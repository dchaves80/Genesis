/*	Code generated via CodeReplicator v1.2a by Ramiro Suriano & Luciano Lapenna, for Olympus Software.	*/
...
IF @DateOfBirth IS NOT NULL
	SET @sql = @sql + ' AND DateOfBirth like @DateOfBirth';
...
INSERT INTO Patients VALUES(@FirstName, @LastName, @DNI, @Address, @Town, @DateOfBirth, @Phone, @IdObraSocial, @HealthCareId, @Sex, @Gender, @ValidateData);
