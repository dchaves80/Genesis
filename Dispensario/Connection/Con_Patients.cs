...
////	Code generated via CodeReplicator v1.2e by Ramiro Suriano, for Olympus Software.	////
...
namespace Connection
{
	public class Con_Patients
	{
		...
		public static DataTable Get_Patients(int? Id, string FirstName, string LastName, string DNI, string Address, string Town, string DateOfBirth, int? Phone, int? IdObraSocial, int? HealthCareId, string Sex, string Gender, bool ValidateData, int? Response)
		{
		...
		public static DataTable Insert_Patients(string FirstName, string LastName, string DNI, string Address, string Town, string DateOfBirth, int? Phone, int? IdObraSocial, int? HealthCareId, string Sex, string Gender, bool ValidateData)
		{
		...
		public static bool Delete_Patients(int? Id, string FirstName, string LastName, string DNI, string Address, string Town, string DateOfBirth, int? Phone, int? IdObraSocial, int? HealthCareId, string Sex, string Gender, bool ValidateData)
		{
		...
		public static bool Update_Patients(int? Id, string FirstName, string LastName, string DNI, string Address, string Town, string DateOfBirth, int? Phone, int? IdObraSocial, int? HealthCareId, string Sex, string Gender, bool ValidateData)
		{
			QTACustomized QTA = new QTACustomized();
